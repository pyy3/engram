...
# 1. Install scripts
mkdir -p "$BIN_DIR"
for script in engram engram-init engram-start engram-end engram-search engram-sync engram-status engram-index engram-qdrant engram-hooks engram-template; do
